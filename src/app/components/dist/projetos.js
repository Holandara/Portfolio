...
exports.Projetos = function (_a) {
    var title = _a.title, icon = _a.icon, _b = _a.items, items = _b === void 0 ? [] : _b, habilidades = _a.habilidades, link = _a.link, github = _a.github;
        ...
        React.createElement("div", { className: "relative rounded-xl h-full" },
            ...
            React.createElement("div", { className: "group-hover:bg-black bg-[#1E1E1E] h-full px-4 py-7 flex flex-col items-start gap-1 rounded-xl border border-transparent" },
                React.createElement("span", { className: " font-heading text-2xl font-semibold text-gray-200 leading-none flex flex-col gap-3" },
                    React.createElement(image_1["default"], { src: icon, alt: title, width: 265, height: 265, className: " object-contain rounded-2xl" }),
                    title),
                React.createElement("ul", { className: "text-sm text-gray-300 leading-none mt-2" },
                ...
                React.createElement("div", { className: "mt-4" },
                    link && (React.createElement("a", { href: link, target: "_blank", rel: "noopener noreferrer", className: "mt-5 font-bold  bg-purple hover:bg-white p-2 rounded-full px-4 text-white hover:text-black transition" }, "Conferir")),
                    github && (React.createElement("a", { href: github, target: "_blank", rel: "noopener noreferrer", className: "ml-2 font-bold  bg-purple hover:bg-white p-2 rounded-full px-4 text-white hover:text-black transition" }, "Reposit\u00F3rio")))))));
};
